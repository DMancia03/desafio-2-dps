...
const validationSchema = Yup.object({
    alquiler: Yup.number().required('Campo obligatorio'),
    canastaBasica: Yup.number().required('Campo obligatorio'),
    financiamiento: Yup.number().required('Campo obligatorio'),
    transporte: Yup.number().required('Campo obligatorio'),
    servicios: Yup.number().required('Campo obligatorio'),
    salud: Yup.number().required('Campo obligatorio'),
    varios: Yup.number().required('Campo obligatorio')
});
